...
Download and load the data from the web and then load it to R.
...
These answers were submitted for grading and all the answers are right, it shows that this random forest model did a good job.
